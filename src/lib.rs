...
#[derive(Debug)]
pub struct VaultLineProcessor {
    verbose: bool,
    processed_count: usize,
}

impl VaultLineProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting VaultLine processing");
    
    let mut processor = VaultLineProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = VaultLineProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = VaultLineProcessor::new(false);
